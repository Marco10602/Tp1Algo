...
\materia{Ciencias de la Computación/Ciencia de Datos}
...
\integrante{Naddeo, Matias}{003/01}{email3@dominio.com}
...
\begin{proc}{poblaciónTotal}{\In ciudades : \TLista{\str\times\ent}{\ent}
	\requiere{\existe[unalinea]{i}{\ent}{(0 \leq i < |ciudades|) \yLuego (ciudadess[i].habitantes > 50.000) y 
 		  \paratodo{i}{\ent}{(0 \leq i < |ciudades|) \implicaLuego (ciudades[i].habitantes >= 0)} y
  		  \paratodo{i}{\ent}\paratodo{j}{\ent}{(0 \leq i, leq j < |ciudades|) \implicaLuego (ciudades[i].nombre != ciudades[j].nombre}
